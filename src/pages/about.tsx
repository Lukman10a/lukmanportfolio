...
export default function About() {
  ...
  const skills = [
    {
      ...
      items: ["React JS", "Next JS", "Framer Motion", "Interactive UI"],
    },
    {
      category: "API Integration",
      items: ["REST APIs", "Axios", "GraphQL", "React Query"],
    },
    {
      category: "Languages",
      items: ["JavaScript", "TypeScript", "Material UI", "Chakra UI"],
    },
    ...
    },
    {
      ...
      items: ["React Native", "Expo", "Nativewind", "GlueStack"],
    },
    {
      category: "Performance Optimization",
      items: ["Profiling", "Debugging", "Code Splitting", "Code Optimization"],
    },
    {
      category: "Backend",
      items: ["Node.js", "MongoDB", "Express", "Firebase", "Supabase"],
    },
  ];
  ...
  const certificates = [
    {
      ...
      image: "advanced_styling_cousera.jpeg",
    },
    {
      name: "Interactivity with JavaScript",
      org: "Coursera (University of Michigan)",
      image: "javascript_cousera.jpg",
    },
    {
      name: "CSS3",
      org: "Coursera (University of Michigan)",
      image: "css_cousera.jpg",
    },
    {
      name: "Modern Javascript",
      org: "Manara",
      image: "modern_javascript_manara.png",
    },
    {
      name: "React - The Complete Guide",
      org: "Udemy",
      image: "react_beginner_udemy.jpg",
    },
  ...
  const badges = [
    ...
    {
      name: "Getting Started Badge",
      image: "getting_started_badge_manara.png",
    },
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl">
            ...
            implementing high-performance user interfaces using React, Next.js,
            and TypeScript. Skilled in building responsive, scalable, and
            accessible web applications for global clients, with a proven track
            record in performance optimization, cloud solutions, and modern
            UI/UX.
          </p>
        </motion.div>
        ...
        >
          <motion.div
            ...
            className="rounded-full overflow-hidden shadow-lg bg-white dark:bg-gray-800 p-4"
          >
            <Image
          ...
          <motion.div variants={itemVariants} className="text-center space-y-2">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-gray-600 dark:text-gray-300 text-sm mt-2">
              <span className="flex items-center gap-1">
                <MapPin className="w-4 h-4 text-brand" /> Lagos, Nigeria
              </span>
              <span className="flex items-center gap-1">
              ...
              <span className="flex items-center gap-1">
                <Calendar className="w-4 h-4 text-brand" /> Available for remote
                & freelance
              </span>
            </div>
          </motion.div>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 grid-cols-2 sm:grid-cols-1 gap-6">
            {skills.map((skill) => (
              ...
              >
                <span className="font-semibold text-brand mb-1">
                  {skill.category}
                </span>
          ...
          <div className="space-y-6">
            ...
            >
              <p className="text-lg text-gray-700 dark:text-gray-200 mb-2">
                <span className="font-semibold text-brand">Expertise:</span> 4+
                years building high-performance, accessible, and scalable web
                applications for global clients (AI, cloud, education, SaaS, and
                more).
              </p>
              <ul className="list-disc pl-6 text-gray-600 dark:text-gray-300 space-y-1">
                <li>
                  ...
                  for modern, maintainable UIs.
                </li>
                <li>
                  Proven results: boosted engagement, improved load speeds, and
                  delivered seamless user experiences for users.
                </li>
                <li>
                  Remote-first: Successfully delivered projects for clients in
                  Australia, Saudi Arabia, UK, USA and globally.
                </li>
                <li>
                  Performance-driven: Advanced code-splitting, profiling, and
                  optimization for rapid, reliable apps.
                </li>
                <li>
                  Accessibility advocate: Built inclusive interfaces and
                  localized apps (i18n, RTL, etc.).
                </li>
                <li>
                  Collaborative: Led UI/UX design, mentored teams, and
              ...
              >
                ...
                {hoveredCert === cert.name && cert.image && (
                  ...
                  >
                    ...
                    />
                    <span className="mt-2 text-xs text-gray-500 dark:text-gray-300 text-center">
                      {cert.name}
                    </span>
                  </motion.div>
                )}
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <EnhancedButton
              href="mailto:abdulrauflukman9@gmail.com"
              variant="primary"
